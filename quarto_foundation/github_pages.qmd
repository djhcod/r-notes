...
## 将本地静态HTML文件发布到GitHub Pages {#sec-将本地静态html文件发布到github-pages}
...
这和 @sec-将本地静态html文件发布到github-pages 一样，不会返回任何信息，但是会在项目根目录中生成一个文件名为`.gitignore`的隐藏文件：

![](images/截屏2023-11-23 11.49.07.png){width="335"}

我们用文本编辑工具或者RStudio打开这个文件。会发现里面已经有一些自动帮我们填好的文件列表：

![](images/截屏2023-11-23 11.50.56.png){width="328"}
...
-   `*_cache`是编译后的缓存文件，它们的后缀为\"\_cache\"：
    ...
    ![](images/截屏2023-11-23 12.20.44.png){width="265"}
