...
### `date-format`的设置 {#sec-dateformat的设置}
...
## `number-sections`标题编号设置 {#sec-number-sections标题编号设置}
...
-   `toc`相关设置：同 @sec-toc目录设置 。

-   `number-sections`、`number-depth`：同 @sec-number-sections标题编号设置 。
