# 多个单细胞数据集整合分析（下） {#sec-multiple_single_cell_datasets_2}

> 参考：[单细胞多数据集整合示例](https://mp.weixin.qq.com/s/51PtUi7ZKp1nbrFGElU74A)

上一节（ @sec-multiple_single_cell_datasets_1 ）中我们完成了对GSE150430的分群注释，并提取了髓系细胞亚群，本节对髓系细胞进一步分群。
...
这里我们参考 @sec-Further_modifications_to_featureplot 中的方法，可视化巨噬细胞marker基因的共表达情况：
